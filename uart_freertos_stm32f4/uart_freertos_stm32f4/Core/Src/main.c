...
int main(void)
{
  ...
  osThreadDef(UartTask02, StartTask02, osPriorityNormal, 0, 128);
  UartTask02Handle = osThreadCreate(osThread(UartTask02), NULL);

  /* definition and creation of UartTask03 */
  osThreadDef(UartTask03, StartTask03, osPriorityBelowNormal, 0, 128);
  UartTask03Handle = osThreadCreate(osThread(UartTask03), NULL);

  /* definition and creation of UartTask04 */
  osThreadDef(UartTask04, StartTask04, osPriorityBelowNormal, 0, 128);
  UartTask04Handle = osThreadCreate(osThread(UartTask04), NULL);
...
void StartTask03(void const * argument)
{
  ...
  for(;;)
  {
	  uint8_t txt1[]="Text from Task 03\r\n ";
	  	 	  HAL_UART_Transmit(&huart2,txt1,sizeof(txt1),500);
    osDelay(500);
  }
...
/**
* @brief Function implementing the UartTask04 thread.
* @param argument: Not used
* @retval None
*/
...
void StartTask04(void const * argument)
{
  ...
  for(;;)
  {
	  uint8_t txt1[]="Text from Task 04\r\n ";
	  	 	  HAL_UART_Transmit(&huart2,txt1,sizeof(txt1),500);
    osDelay(500);
  }
